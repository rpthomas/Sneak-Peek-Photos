...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.JED.Sneak_Peek_Photos" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("Sneak_Peek_Photos", withExtension: "momd")!
    ...
    func applicationDidTimout(notification: NSNotification) {
        if let vc = self.window?.rootViewController  {
            if let myViewController = vc.presentedViewController as? LoginView {
                ...
                let viewController: LoginView = storyboard.instantiateViewControllerWithIdentifier("MyMainStoryBoard") as! LoginView
