...
internal class DKAssetGroupDetailVC: UICollectionViewController, DKGroupDataManagerObserver {
    ...
    override func collectionView(collectionView: UICollectionView, shouldSelectItemAtIndexPath indexPath: NSIndexPath) -> Bool {
        if let firstSelectedAsset = DKImagePickerController.sharedInstance().selectedAssets.first,
            ...
            displayFailureAlert(title: DKImageLocalizedStringWithKey("selectPhotosOrVideos"), body: DKImageLocalizedStringWithKey("selectPhotosOrVideosError"))
		...
		//if !shouldSelect {
			//DKImagePickerController.sharedInstance().UIDelegate.imagePickerControllerDidReachMaxLimit(DKImagePic//kerController.sharedInstance())
		//}
    ...
    override func collectionView(collectionView: UICollectionView, didSelectItemAtIndexPath indexPath: NSIndexPath) {
        ...
        print(selectedAsset?.description)
